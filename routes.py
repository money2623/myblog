...
from start_utils import app, db, bcrypt, mail
...
def login():
	...
	if form.validate_on_submit():
		...
		if user and bcrypt.check_password_hash(user.password, form.password.data):
			...
			flash('Login Unsucessful, Please check email or password','danger')
...
def save_picture(form_picture):
	random_hex = str(current_user.id) + '_' + str(int(time.time()))
